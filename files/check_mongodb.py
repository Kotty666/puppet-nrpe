...
#   - Jochen Vetter, Manuel Leiner - mongo_connect() authentication for check_connect_primary
#
# USAGE
#
# See the README.md
...
def main(argv):
    ...
    if action == "connections":
        ...
        return check_connect_primary(con, warning, critical, perf_data, options)
...
def check_connect_primary(con, warning, critical, perf_data, options):
    warning = warning or 3
    critical = critical or 6
    ...
    try:
        ...
        err, con = mongo_connect(phost, pport, ssl, user, passwd, replicaset)
        if err != 0:
            return err
